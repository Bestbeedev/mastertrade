            ...
            <div className="w-full px-4 sm:px-6 lg:px-8 py-8 space-y-8">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-2 max-w-2xl">
                            Retrouvez les réponses aux questions les plus fréquentes sur Mastertrade.
                        </p>
                    </div>
                ...
                <Card>
                    <CardHeader>
                        ...
                        <CardDescription>
                            Cliquez sur une question pour voir l'article d'aide complet.
                        </CardDescription>
                    </CardHeader>
