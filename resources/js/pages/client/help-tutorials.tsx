...
export default function HelpTutorials() {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        ...
        { title: 'Tutoriels', href: route('helps.tutorials') },
    ];
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Centre d'aide • Tutoriels" />
            ...
            <div className="w-full px-4 sm:px-6 lg:px-8 py-8 space-y-8">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        ...
                        <p className="text-muted-foreground mt-2 max-w-2xl">
                            Découvrez des tutoriels pratiques pour apprendre à utiliser les fonctionnalités de Mastertrade.
                        </p>
                    </div>
                ...
                <Card>
                    <CardHeader>
                        <CardTitle>Tutoriels disponibles</CardTitle>
                        <CardDescription>
                            Pas à pas, vidéos et guides détaillés.
                        </CardDescription>
                    </CardHeader>
                                ...
                                <div className="flex items-start justify-between gap-4">
                                    <div className="flex-1">
                                        <div className="flex items-center gap-2 mb-1">
                                            <Badge variant="outline" className="text-xs">Tutoriel</Badge>
